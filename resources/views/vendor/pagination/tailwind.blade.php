            ...
            <div>
                <span class="relative z-0 inline-flex rtl:flex-row-reverse  rounded-md">
                    ...
                    <a href="{{ $paginator->previousPageUrl() }}" rel="next" 
                        class="h-10 w-10 font-semibold text-gray-800 hover:text-blue-900 hover:underline text-sm flex items-center justify-center mr-3" aria-label="{{ __('pagination.next') }}">
                        Prev
                    ...
                    {{-- Next Page Link --}}
                    @if ($paginator->hasMorePages())
                        <a href="{{ $paginator->nextPageUrl() }}" rel="next" class="h-10 w-10  font-semibold text-gray-800 hover:text-blue-900 hover:underline text-sm flex items-center justify-center ml-3" aria-label="{{ __('pagination.next') }}">
                            Next
